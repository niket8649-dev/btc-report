...
4️⃣ 포지션 추천 (오늘의 결론)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎯 추천 포지션: [🟢 롱 / 🔴 숏 / ⚪ 관망] — 확신도: XX%
📋 추천 근거: [2~3문장으로 왜 이 포지션인지 명확하게]

🟢 롱(매수) 전략
  진입가: $XX,XXX ~ $XX,XXX
  목표가 1: $XX,XXX (+X.X%) — 1차 익절
  목표가 2: $XX,XXX (+X.X%) — 2차 익절
  손절가: $XX,XXX (-X.X%)
  추천 레버리지: Xx (최대 Xx)
  진입 조건: [구체적 조건]
  포지션 사이징: [전체 자본의 XX% 권장]
...
7️⃣ 향후 6개월 비트코인 가격 전망
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  1개월 후 예상 범위: $XX,XXX ~ $XX,XXX
  3개월 후 예상 범위: $XX,XXX ~ $XX,XXX
  6개월 후 예상 범위: $XX,XXX ~ $XX,XXX

  📈 상승 시나리오 (확률 XX%):
  • [조건 및 목표가]
  • 주요 촉매: [ETF 수급/반감기 효과/매크로 등]
...
"""
    ...
    return remove_non_korean_cjk(text)
